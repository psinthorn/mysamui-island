    ...
    <div className='hero'>
        ...
        <div className="flex flex-col w-full  mx-auto px-4 mt-10 space-y-12 md:flex-row md:space-y-0">
          <div className='flex flex-col space-y-12 md:w-1/2' >
            ...
            <h1 className="max-w-sm head_text blue_gradient text-center md:text-left">Book With Us NOW</h1>
            <p className='max-w-sm text-gray-700 text-center md:text-left'>{cardList} Koh Samui, Island trip, book a ticket for speed boat Quick & Easily.</p>
          </div>
          ...
          { packageInfo.map((tour) => (
            <div>
              ...
              {/* heading  */}
              <div className="rounded-full text-white bg-blue-500 md:bg-transparent">
              ...
              <p className="flex text-gray-700 px-4">
                  {tour.info}
              </p>
              <div className="text-center py-8 md:text-righ">
